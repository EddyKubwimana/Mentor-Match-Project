        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              ...
              <p class="mb-0" data-aos="fade-up" data-aos-delay="300"><a href="#" class="btn btn-secondary">Explore our web application</a></p>
    ...
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Someone may learn from you or you may learn from someone, join us </p>

          <ul class="ul-check list-unstyled mb-5 primary" data-aos="fade-up" data-aos-delay="200">
            <li>Unlock the doors of opportunity through the key of education.</li>
            <li>Guiding lights pave the path, mentors inspire greatness in learning</li>
            <li>In the dance of knowledge, mentors are the steady rhythm guiding our steps</li>
          </ul>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
          ...
          <p>The greatest advantage of mentorship in the learning process is not just gaining knowledge, but also acquiring the wisdom to navigate the journey of growth with purpose and clarity.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="staff text-center">
            <div class="mb-4"><img src="images/eddy.png" alt="Image" class="img-fluid"></div>
            <div class="staff-body">
              <h3 class="staff-name">Eddy kubwimana</h3>
              <span class="d-block position mb-4">Founder of Mentor Match</span>
              <p class="mb-4">Empowering Dreams, Fostering Connections: Bridging Aspirations, One Mentorship at a Time.</p>
              <div class="social">
